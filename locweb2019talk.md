...
![](working-clipart-construction-8.png){ width=7% }
...
- Very high anti-correlation b/w number of accesses and dimensions of
  clusters (P=-0.92, p-value = 0.029): the smallest clusters (ABC1 and
  C2) are overall the most active
...
# Limitations
![](https://newvitruvian.com/images250_/working-clipart-construction-8.png){ width=7% }

- Datasets are not well understood
...
- Ministry of Transportation (gender)
- INE
- Uber
- UN and policy
